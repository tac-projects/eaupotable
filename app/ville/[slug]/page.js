  ...
  try {
    ...
    if (!deptCode) {
      ...
      const legacyRedirects = {
        'ann-ullin': 'annoeullin',
        'arg-uves': 'argoeuves',
        'arrancy-sur-crusnes': 'arrancy-sur-crusne',
        'bab-uf': 'baboeuf',
        'beaumont-les-nonains': 'les-hauts-talican',
        'c-ur-de-la-vallee': 'coeur-de-la-vallee',
        'castellet-en-luberon': 'castellet',
        'chamb-uf': 'chamboeuf',
        'champdeniers': 'champdeniers-saint-denis',
        'corbieres-en-provence': 'corbieres',
        'crevec-ur-le-petit': 'crevecoeur-le-petit',
        'cricqueb-uf': 'cricqueboeuf',
        'esc-uilles': 'escoeuilles',
        'escorneb-uf': 'escorneboeuf',
        'exideuil-sur-vienne': 'exideuil',
        'g-rlingen': 'goerlingen',
        'grandchamp-des-fontaines': 'grandchamps-des-fontaines',
        'grigny-sur-rhone': 'grigny-69',
        'j-uf': 'joeuf',
        'k-ur-la-petite': 'koeur-la-petite',
        'labatut-figuieres': 'labatut-40',
        'laval-en-belledonne': 'laval',
        'lignieres-ambleville': 'ligniere-ambleville',
        'm-urs-verdey': 'moeurs-verdey',
        'mehuna-sur-yevre': 'mehun-sur-yevre',
        'menitre': 'la-menitre',
        'merc-ur': 'mercoeur',
        'moncourt-fromonville': 'montcourt-fromonville',
        'mons-en-bar-ul': 'mons-en-baroeul',
        'montignac-lascaux': 'montignac',
        'n-ux-les-auxi': 'noeux-les-auxi',
        'n-ux-les-mines': 'noeux-les-mines',
        'ponts-de-ce': 'les-ponts-de-ce',
        'qu-ux-haut-mainil': 'quoeux-haut-mainil',
        'rairies': 'les-rairies',
        'saint-jean-de-b-uf': 'saint-jean-de-boeuf',
        'saint-pierre-de-b-uf': 'saint-pierre-de-boeuf',
        'salleb-uf': 'salleboeuf',
        'sch-lcher': 'schoelcher',
        'sch-nau': 'schoenau',
        'sch-nbourg': 'schoenbourg',
        'tessoualle': 'la-tessoualle',
        'thub-uf': 'thuboeuf',
        'thury-harcourt-le-hom': 'le-hom',
        'togny-aux-b-ufs': 'togny-aux-boeufs',
        'uilly': 'oeuilly',
        'v-lfling-les-bouzonville': 'voelfling-les-bouzonville',
        'vand-uvre-les-nancy': 'vandoeuvre-les-nancy',
        'vend-uvres': 'vendoeuvres',
        'villiers-en-des-uvre': 'villiers-en-desoeuvre',
      };
