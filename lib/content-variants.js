...
export const FOCUS_VARIANTS = {
  calcaire: {
    eleve: [
      ...
      { titre: "Tartre & Calcaire à {cityName}", texte: "La dureté de l'eau atteint {dureteVal} à {cityName}. Concrètement, vos robinets et votre bouilloire s'entartrent vite. Un adoucisseur au point d'entrée peut résoudre le problème à la source." },
    ...
    moyenne: [
      { titre: "Un bon équilibre minéral à {cityName}", texte: "Avec {dureteVal}, l'eau de {cityName} présente un équilibre satisfaisant. Ni trop calcaire, ni trop douce : vos appareils ne souffriront pas d'un entartrage excessif." },
  ...
  sante: {
    ...
    vigilance: [
      { titre: "Vigilance & Santé à {cityName}", texte: "La qualité de l'eau à {cityName} présente des points d'attention (Nitrates : {nitratesVal}, PFAS : {pfasVal}). Une vigilance particulière est recommandée pour les nourrissons et les personnes immunodéprimées." },
      ...
      { titre: "Surveillance recommandée à {cityName}", texte: "L'eau de {cityName} présente des traces de contaminants (nitrates : {nitratesVal}, PFAS : {pfasVal}). Pour les personnes fragiles, une filtration complémentaire est un choix prudent." },
    ],
    bonne: [
