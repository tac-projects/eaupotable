...
export const PARAMS = [
  ...
  { key: 'pesticides', dataKey: 'pesticides', name: 'Pesticides', seoLabel: 'Pesticides totaux', limit: '0.5 µg/L', unit: 'µg/L', dossier: 'sante', dossierOrder: 3, cardOrder: 3, scored: true },
...
/** Les 14 paramètres de la table SEO, groupés (structure attendue par le registre SEO). */
