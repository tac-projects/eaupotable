...
export async function fetchCitySummary(cityName) {
  try {
    ...
    const stats = {
      nitrates: getParamLegacy([1340, 1342], ["nitrate"]),
      ph: getParamLegacy([1301, 1302], ["ph", "potentiel hydrogene"], ["ph"]),
      hardness: getParamLegacy([1345], ["hydrotimetrique", "durete", "calcaire", "th", "titre"]),
      chlorine: getParamLegacy([1399], ["chlore libre", "chlore total"]),
      ...
      pesticides: getParamLegacy([1107, 1667, 6272, 6273, 6274, 6275, 6276, 6277], ["pesticide"]),
      ammonium: getParamLegacy([1331], ["ammonium"]),
