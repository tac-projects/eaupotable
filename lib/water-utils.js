...
export async function harvestWaterData(cityName) {
    try {
        ...
        const stats = {
            ...
            ph: getParam([1301], ["ph", "potentiel hydrogene"], ["ph"]),
            ...
            turbidity: getParam([1305], ["turbidite"], ["NFU", "NTU", "SiO2"]),
            pesticides: getParam([6276], ["pesticide"]) || getParam([1107, 1667, 6272, 6273, 6274, 6275, 6277, 6278, 6279, 6280, 7150], []),
        ...
        if (allReseauCodes.length > 0) {
            ...
            const fallbackConfig = {
                nitrates: "1340,1342", ph: "1301", hardness: "1345,2708", chlorine: "1399,1398", 
