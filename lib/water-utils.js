...
export async function harvestWaterData(cityName) {
    try {
        ...
        const getParam = (codes, keywords, requiredUnits = []) => {
            ...
            const isBact = [1449, 1447, 1042, 6455, 1448].some(c => codes.includes(c));
        ...
        const stats = {
            nitrates: getParam([1340], []),
            ph: getParam([1302], ["ph", "potentiel hydrogene"], ["ph"]),
            hardness: getParam([1345], ["hydrotimetrique", "durete", "th"]),
            chlorine: getParam([1398, 1399, 1754], ["chlore libre", "chlore total"]),
            conductivity: getParam([1303, 1304], ["conductivite"], ["µS", "siemens", "us/cm"]),
            turbidity: getParam([1295], ["turbidite"], ["NFU", "NTU", "SiO2"]),
            pesticides: getParam([6276], ["pesticide"]),
            pfas: getParam([8847, 9268], ["pfas", "perfluoro"]),
            microbiology: getParam([1449, 1447, 1042, 6455, 1448], ["escherichia", "enterocoques", "coliformes"]),
            iron: getParam([1393], ["fer total", "fer dissous"]),
            manganese: getParam([1394], ["manganese"]),
            ammonium: getParam([1335], ["ammonium"]),
            copper: getParam([1392], ["cuivre"]),
            cot: getParam([1841], ["organique total", "cot"])
        };
        ...
        if (allReseauCodes.length > 0) {
            ...
            const fallbackConfig = {
                nitrates: "1340", ph: "1302", hardness: "1345", chlorine: "1398,1399,1754", 
                conductivity: "1303,1304", turbidity: "1295", pesticides: "6276", 
                pfas: "8847,9268", microbiology: "1449,1447,1042,6455,1448",
                iron: "1393", manganese: "1394", ammonium: "1335", copper: "1392", cot: "1841"
            };
