...
- **`report.md`** contient : synthèse **recommandations auto-générées**, totaux GSC, segments, **opportunités** (pos 5-15, imp ≥ 200, CTR < 2 %), **déclins** (clics B ≥ 5, > 15 %), **indexation**, **santé sitemap**, GA4 (canaux, appareils, landing, events, `search_no_result`).
